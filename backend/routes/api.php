...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::patch('sales/{sale}/deliver', [SaleController::class, 'markDelivered'])->whereNumber('sale');
        ...
        Route::get('sales/{sale}/pickup-doc', [SaleController::class, 'pickupDoc'])
...
Route::post('/password/forgot', [CustomerAuthController::class, 'forgotPassword']); // ✅ ARREGLADO
...
//
Route::post('/products/search/click', [SearchTelemetryController::class, 'productClick'])->middleware('throttle:60,1');
Route::post('/events/search/click', [SearchTelemetryController::class, 'eventClick'])->middleware('throttle:60,1');
Route::post('/products/{id}/prefer', [ProductPreferenceController::class, 'prefer'])->whereNumber('id')->middleware('throttle:120,1');
Route::post('/events/{id}/prefer', [EventPreferenceController::class, 'prefer'])->whereNumber('id')->middleware('throttle:120,1');
